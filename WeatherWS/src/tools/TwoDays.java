...
//weather information for today and tomorrow only
//should despay the columns date1 and date2
public class TwoDays {
	
	public WeatherInfo twoDaysData(String zip, String city)
	{
		...
		try {
			...
			String SQLString = "SELECT * from weather_info where date1 = '"+today+"' and zip = '" + zip + "';";
			if(zip.isEmpty())
			{
				SQLString = "SELECT * from weather_info where date1 = '"+today+"' and city = '" + city + "';";
			}
