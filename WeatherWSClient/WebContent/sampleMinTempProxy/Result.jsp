...
<jsp:useBean id="sampleMinTempProxyid" scope="session" class="tools.MinTempProxy" />
<%
if (request.getParameter("endpoint") != null && request.getParameter("endpoint").length() > 0)
sampleMinTempProxyid.setEndpoint(request.getParameter("endpoint"));
%>
...
case 2:
        gotMethod = true;
        java.lang.String getEndpoint2mtemp = sampleMinTempProxyid.getEndpoint();
...
case 5:
        ...
        sampleMinTempProxyid.setEndpoint(endpoint_0idTemp);
break;
case 10:
        gotMethod = true;
        tools.MinTemp getMinTemp10mtemp = sampleMinTempProxyid.getMinTemp();
if(getMinTemp10mtemp == null){
%>
<%=getMinTemp10mtemp %>
<%
}else{
        if(getMinTemp10mtemp!= null){
        String tempreturnp11 = getMinTemp10mtemp.toString();
        %>
        <%=tempreturnp11%>
        <%
        }}
...
case 13:
        ...
        tools.WeatherInfo minTemp13mtemp = sampleMinTempProxyid.minTemp(zip_1idTemp,city_2idTemp);
if(minTemp13mtemp == null){
%>
<%=minTemp13mtemp %>
<%
}else{
...
<%
if(minTemp13mtemp != null){
java.lang.String typecode16 = minTemp13mtemp.getCode();
...
<%
if(minTemp13mtemp != null){
java.lang.String typelongit18 = minTemp13mtemp.getLongit();
...
<%
if(minTemp13mtemp != null){
java.lang.String typeu_speed20 = minTemp13mtemp.getU_speed();
...
<%
if(minTemp13mtemp != null){
java.lang.String typew_speed22 = minTemp13mtemp.getW_speed();
...
<%
if(minTemp13mtemp != null){
java.lang.String typelow224 = minTemp13mtemp.getLow2();
...
<%
if(minTemp13mtemp != null){
java.lang.String typelow126 = minTemp13mtemp.getLow1();
...
<%
if(minTemp13mtemp != null){
java.lang.String typea_visibility28 = minTemp13mtemp.getA_visibility();
...
<%
if(minTemp13mtemp != null){
java.lang.String typetemp30 = minTemp13mtemp.getTemp();
...
<%
if(minTemp13mtemp != null){
java.lang.String typeu_distance32 = minTemp13mtemp.getU_distance();
...
<%
if(minTemp13mtemp != null){
java.lang.String typehigh234 = minTemp13mtemp.getHigh2();
...
<%
if(minTemp13mtemp != null){
java.lang.String typehigh136 = minTemp13mtemp.getHigh1();
...
<%
if(minTemp13mtemp != null){
java.lang.String typea_humidity38 = minTemp13mtemp.getA_humidity();
...
<%
if(minTemp13mtemp != null){
java.lang.String typelatit40 = minTemp13mtemp.getLatit();
...
<%
if(minTemp13mtemp != null){
java.lang.String typecity42 = minTemp13mtemp.getCity();
...
<%
if(minTemp13mtemp != null){
java.lang.String typeu_temperature44 = minTemp13mtemp.getU_temperature();
...
<%
if(minTemp13mtemp != null){
java.lang.String typew_chill46 = minTemp13mtemp.getW_chill();
...
<%
if(minTemp13mtemp != null){
java.lang.String typecode248 = minTemp13mtemp.getCode2();
...
<%
if(minTemp13mtemp != null){
java.lang.String typecode150 = minTemp13mtemp.getCode1();
...
<%
if(minTemp13mtemp != null){
java.lang.String typezip52 = minTemp13mtemp.getZip();
...
<%
if(minTemp13mtemp != null){
java.lang.String typetext254 = minTemp13mtemp.getText2();
...
<%
if(minTemp13mtemp != null){
java.lang.String typetext156 = minTemp13mtemp.getText1();
...
<%
if(minTemp13mtemp != null){
java.lang.String typedate258 = minTemp13mtemp.getDate2();
...
<%
if(minTemp13mtemp != null){
java.lang.String typedate160 = minTemp13mtemp.getDate1();
...
<%
if(minTemp13mtemp != null){
java.lang.String typetext62 = minTemp13mtemp.getText();
...
<%
if(minTemp13mtemp != null){
java.lang.String typesunrise64 = minTemp13mtemp.getSunrise();
...
<%
if(minTemp13mtemp != null){
java.lang.String typea_pressure66 = minTemp13mtemp.getA_pressure();
...
<%
if(minTemp13mtemp != null){
java.lang.String typecountry68 = minTemp13mtemp.getCountry();
...
<%
if(minTemp13mtemp != null){
java.lang.String typeday270 = minTemp13mtemp.getDay2();
...
<%
if(minTemp13mtemp != null){
java.lang.String typeday172 = minTemp13mtemp.getDay1();
...
<%
if(minTemp13mtemp != null){
java.lang.String typeu_pressure74 = minTemp13mtemp.getU_pressure();
...
<%
if(minTemp13mtemp != null){
java.lang.String typedate76 = minTemp13mtemp.getDate();
...
<%
if(minTemp13mtemp != null){
java.lang.String typeerrorMsg78 = minTemp13mtemp.getErrorMsg();
...
<%
if(minTemp13mtemp != null){
java.lang.String typeext80 = minTemp13mtemp.getExt();
...
<%
if(minTemp13mtemp != null){
java.lang.String typew_direction82 = minTemp13mtemp.getW_direction();
...
<%
if(minTemp13mtemp != null){
java.lang.String typeregion84 = minTemp13mtemp.getRegion();
...
<%
if(minTemp13mtemp != null){
java.lang.String typesunset86 = minTemp13mtemp.getSunset();
...
<%
if(minTemp13mtemp != null){
java.lang.String typea_rising88 = minTemp13mtemp.getA_rising();
