...
public class TempConvertServiceLocator extends org.apache.axis.client.Service implements tools.TempConvertService {
    ...
    private java.lang.String TempConvert_address = "http://localhost:8080/WeatherWS/services/TempConvert";
    ...
    public tools.TempConvert getTempConvert(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            tools.TempConvertSoapBindingStub _stub = new tools.TempConvertSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (tools.TempConvert.class.isAssignableFrom(serviceEndpointInterface)) {
                tools.TempConvertSoapBindingStub _stub = new tools.TempConvertSoapBindingStub(new java.net.URL(TempConvert_address), this);
                _stub.setPortName(getTempConvertWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://tools", "TempConvertService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://tools", "TempConvert"));
        }
